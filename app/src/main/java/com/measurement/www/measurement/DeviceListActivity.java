...
public class DeviceListActivity extends AppCompatActivity {
    ...
    private Toolbar mDeviceListActivityToolBar;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDeviceListActivityToolBar = (Toolbar) findViewById(R.id.DeviceListActivity_toolbar);
        setSupportActionBar(mDeviceListActivityToolBar);
        ...
        mButton2 = (Button) findViewById(R.id.button_remove);
        mButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder clear = new AlertDialog.Builder(DeviceListActivity.this);
                clear.setTitle("温馨提示");
                clear.setMessage("亲，确定要清空吗？");
    ...
    private void setToolBar(String str){
        mDeviceListActivityToolBar.setSubtitle(str);
    }
